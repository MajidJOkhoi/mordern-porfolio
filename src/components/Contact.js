...
const Contact = () => {
  return (
    <>
      <div className="w-full px-5 md:px-0 bg-gray-200 border-t-2 border-white">
            ...
            <div className="mt-12">
              ...
              <ul className="mt-4">
                <li className="flex gap-3 items-center">
                  <IoIosMail size={35} className="text-orange-500" />
            ...
            <div className="mt-12">
              ...
              <ul className="flex mt-4 space-x-4">
                <li className="h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                  <a
                    href="https://www.facebook.com/profile.php?id=100032015292163"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Facebook"
                  >
                    <FaFacebook size={35} className="text-orange-500" />
                  </a>
                </li>
                <li className="h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                  <a
                    href="https://github.com/MajidJOkhoi"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="GitHub"
                  >
                ...
                <li className="h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                  <a
                    href="https://www.linkedin.com/in/majidali513"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="LinkedIn"
                  >
                    <FaLinkedin size={35} className="text-orange-500" />
                  </a>
                </li>
              </ul>
            </div>
