      ...
      >
        <div className="mb-8 max-w-7xl mx-auto text-center">
          <h2 className="text-gray-800 text-3xl my-3 font-extrabold">
            Clients <span className="text-orange-500"> Rating & Reviews  </span> 
          </h2>
          <p>
        Hear from the people who matter most—our valued clients! Their experiences of success and satisfaction drive us to continuously deliver exceptional service. From outstanding quality to unparalleled support, discover why our clients choose to partner with us time and time again.
          </p>
        </div>
